...
- **`r names(datos)[28]`** es la clasificación de si se cumplió con el Límite del Tiempo de Respuesta, 1 = sí y 0 = no.
...
```{r}
tabla1 <- datos %>% group_by(Recepcion) %>%  summarise()

time_s <- ts(datos,freq=12, start = c(2018-01-08))
```
