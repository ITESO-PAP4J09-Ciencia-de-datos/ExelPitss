...
tiempos_os_tidy_tbl <- tiempos_os_tbl %>%
  ...
  rename(
    ...
    Tiempo_limite_restante_de_respuesta      = `Tiempo límite restante de respuesta`,
    Tiempo_limite_restante_de_solución_total =`Tiempo límite restante de solución total`
  ) %>%
